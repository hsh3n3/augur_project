...
@register_metric()
def deps5(self, repo_group_id, repo_id=None, period='day', begin_date=None, end_date=None):
    """
    Returns a timeseries of all the contributions to a project.
...
def deps3():
	...
	return 'Sup Boiiiiiiiii!'

@app.route("/")
def deps4():

	return 'ThebigOl deps 4 route'
